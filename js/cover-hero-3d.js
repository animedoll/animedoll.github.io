...
(function () {
  ...
  renderer.toneMappingExposure = 1.185;
  ...
  const ambient = new THREE.AmbientLight(0xe8f4ff, 0.36);
  scene.add(ambient);
  const hemi = new THREE.HemisphereLight(0xd0ecff, 0x1f303c, 0.95);
  scene.add(hemi);
  const key = new THREE.DirectionalLight(0xffffff, 1.75);
  key.position.set(2.3, 3.85, 2.1);
  scene.add(key);
  const fill = new THREE.DirectionalLight(0xc8e2ff, 0.36);
  fill.position.set(-3.2, 2.1, 1.4);
  scene.add(fill);
  const bounce = new THREE.DirectionalLight(0xa8d4f0, 0.19);
  bounce.position.set(0.8, -2.8, 1.2);
  scene.add(bounce);
  const rim = new THREE.DirectionalLight(0x42bde8, 0.715);
